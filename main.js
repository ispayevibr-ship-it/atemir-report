...
ipcMain.on("app:update-check",async()=>{sendUpdate("checking");hotUpdate=null;let hot=await checkHotUpdate();if(!hot)autoUpdater.checkForUpdates().catch(e=>sendUpdate("error",{message:e.message}))});
