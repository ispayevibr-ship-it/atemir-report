...
$("#content").onchange=async e=>{if(e.target.dataset.list){const key=e.target.dataset.list,r=arr(key)[+e.target.dataset.i],k=e.target.dataset.k;if(r){r[k]=e.target.value;
