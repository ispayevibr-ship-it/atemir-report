...
function financeView(){
 ...
 return analytics+contracts+actCard+`<div class="financeActions"><button class="btn" data-finance-password>Изменить пароль</button><button class="danger" data-finance-lock>Закрыть раздел</button></div>`
}
