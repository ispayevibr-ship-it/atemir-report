...
let bomFilter="all";
let state={companyName:"",object:"",address:"",client:"",reportDate:"",weather:{temp:"",wind:"",precip:""},workTypes:[],tasks:[],workDays:[],invoices:[],workers:[],responsibles:[],equipment:[],deadlines:[],actedDays:[],penalties:[],reportPhotos:[],companyLogo:"",reportSections:{}},view="home",manageView="object";
...
function normalizeState(d){
 ...
 const base={companyName:"",object:"",address:"",client:"",reportDate:"",weather:{temp:"",wind:"",precip:""},workTypes:[],tasks:[],workDays:[],invoices:[],workers:[],responsibles:[],equipment:[],deadlines:[],actedDays:[],penalties:[],reportPhotos:[],companyLogo:"",reportSections:{}};
