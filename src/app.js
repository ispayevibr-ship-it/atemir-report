...
let bomFilter="all",financeUnlocked=false;
...
(async()=>{const d=await ATemir.load();state=normalizeState(d?{...state,...d}:state);hydrateRowUnits();render()})().catch(e=>alert("Ошибка запуска: "+e.message));
